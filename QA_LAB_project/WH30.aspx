<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WH30.aspx.cs" Inherits="QA_LAB_project.WH30" %>
        ...
        <div id="disp">
            ...
            <div class="panel panel-default" style="width: 800px; margin-left: 50px">
                <div class="panel panel-default" style="width: 400px; margin-left: 200px">
                    <p style="text-align: center; line-height: .5"><b>WET HYDRATE CAKE QUALITY REPORT</b></p>
                    ...
                    <h3>
                        <p style="text-align: center; line-height: .5">WH-30</p>
                    </h3>
                ...
                <div class="table-responsive" style="margin-left: 100px; float: left">
                    ...
                    <asp:GridView ID="gv_reportWH30" runat="server" Height="16px" Width="260px"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Test" ItemStyle-Width="50" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:TextBox ID="Wh30name" runat="server" Text='<%# Eval("name") %>' Width="150px" BorderStyle="None" Style="text-align: left"></asp:TextBox>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Results" ItemStyle-Width="50" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:TextBox ID="Wh30val" runat="server" Text='<%# Eval("value", "{0:.###}") %>' Width="100px" BorderStyle="None" Style="text-align: center"></asp:TextBox>
                                </ItemTemplate>
                                <ItemStyle Width="50px"></ItemStyle>
                            </asp:TemplateField>
                        </Columns>
                ...
                <div class="table-responsive" style="float: left; padding-left: 10px">
                    ...
                    <asp:GridView ID="gv_reportWH30_2" runat="server" Height="16px" Width="260px"
                        Style="overflow-x: scroll; border-radius: 3px"
                        AutoGenerateColumns="False"
                        GridLines="Horizontal"
                        BorderStyle="None">
                        <Columns>
                            <asp:TemplateField HeaderText="Test" ItemStyle-Width="50" HeaderStyle-HorizontalAlign="Left" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:TextBox ID="Wh30name" runat="server" Text='<%# Eval("name") %>' Width="180px" BorderStyle="None"></asp:TextBox>
                                </ItemTemplate>
                                <ItemStyle Width="50px"></ItemStyle>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Results" ItemStyle-Width="50" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:TextBox ID="Wh30val" runat="server" Text='<%# Eval("value", "{0:.###}") %>' Width="150px" BorderStyle="None" Style="text-align: center"></asp:TextBox>
                                </ItemTemplate>
                                <ItemStyle Width="50px"></ItemStyle>
                            </asp:TemplateField>
                ...
                <div class="table-responsive" style="float: left; margin-left: 140px; background-color: white">
                    <br />
                    <br />
                    <asp:GridView ID="gv_reportWH30_3" runat="server" Height="16px" Width="250px"
                        ...
                        <Columns>
                            <asp:TemplateField ItemStyle-Width="50" HeaderText="Truck/Railcar No." HeaderStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                                    <asp:TextBox ID="Wh30_1" Style="padding: 0;" runat="server" Text='<%# Eval("name") %>' Width="140px" BorderStyle="None"></asp:TextBox>
                                </ItemTemplate>
                                <ItemStyle Width="50px"></ItemStyle>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="% Refelectance" ItemStyle-Width="50">
                                <ItemTemplate>
                                    <asp:TextBox ID="Wh30_2" runat="server" Text='<%# Eval("reflectance") %>' Width="120px" BorderStyle="None" Style="text-align: center"></asp:TextBox>
                                </ItemTemplate>
                                <ItemStyle Width="50px"></ItemStyle>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="% Leachable" ItemStyle-Width="50">
                                <ItemTemplate>
                                    <asp:TextBox ID="Wh30_3" runat="server" Text='<%# Eval("lsoda") %>' Width="120px" BorderStyle="None" Style="text-align: center"></asp:TextBox>
                                </ItemTemplate>
                                <ItemStyle Width="50px"></ItemStyle>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="% Solids" ItemStyle-Width="50">
                                <ItemTemplate>
                                    <asp:TextBox ID="Wh30_4" runat="server" Text='<%# Eval("psolid") %>' Width="120px" BorderStyle="None" Style="text-align: center"></asp:TextBox>
                                </ItemTemplate>
                                <ItemStyle Width="50px"></ItemStyle>
                            </asp:TemplateField>
                        </Columns>
                ...
                <%--         <div style="width: 300px; margin-left: 0px">
                        <p style="white-space: nowrap; line-height: 0.5px">This material meets all customer specifications.______________________________</p>
                        <p style="white-space: nowrap; margin-left: 330px; line-height: 0.5px">Quality Control Approval</p>
                    </div>
                --%>
            </div>
