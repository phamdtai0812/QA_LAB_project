...
{
    public partial class LabTicket2 : System.Web.UI.Page
    {
        ...
        protected void lbDownloadFile_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Outlook.Attachment oAttach = oMsg.Attachments.Add
                                             (@"C:\\Test\Test2.txt", iAttachType, iPosition, sDisplayName);
                //Subject line
                oMsg.Subject = "Your Subject will go here.";
                // Add a recipient.
                Outlook.Recipients oRecips = (Outlook.Recipients)oMsg.Recipients;
                // Change the recipient in the next line if necessary.
                Outlook.Recipient oRecip = (Outlook.Recipient)oRecips.Add("tai.pham@norandaalumina.com");
                oRecip.Resolve();
                // Send.
                oMsg.Send();
                // Clean up.
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            using (StringWriter sw = new StringWriter())
            {
                ...
                {
                    gv_labticket1.RenderControl(hw);
