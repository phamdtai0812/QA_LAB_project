<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LabTicket2.aspx.cs" EnableEventValidation="false"
    Inherits="QA_LAB_project.LabTicket2" %>
                        ...
                        <div class="table-responsive" style="float: left; width: auto">
                            ...
                            <asp:GridView ID="gv_labticket5" runat="server" Height="16px"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="" ItemStyle-Width="50">
                                        <ItemTemplate>
                                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("s") %>' Width="100px"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                            ...
                            <asp:GridView ID="gv_labticket6" runat="server" 
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="" ItemStyle-Width="50">
                                        <ItemTemplate>
                                            <asp:Label ID="Label2" runat="server" Text='<%# Eval("s") %>' Width="100px"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
